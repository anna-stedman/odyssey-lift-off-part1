...
const TrackCard = ({ track }) => {
  ...
  // useMutation returns an array of two objects
  // The first element is the mutate function
  // The second element is an object with information abou the mutation: loading, error, data
